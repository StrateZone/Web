...
//       console.log("[checkTableInvitations] Dữ liệu nhận được:", data);
...
//     const hasInvitations = await checkTableInvitations(
//       booking.tableId,
//       booking.startDate,
//       booking.endDate
//     );
...
//                         className={`p-2 ${
//                           booking.hasInvitations
//                             ? "text-blue-300 hover:text-blue-300 cursor-not-allowed"
...
//                             : "Mời bạn vào bàn này"
//                         }
//                         disabled={booking.hasInvitations}
//                       >
//                         <UserPlus size={24} />
//                       </button>
...
//                     </div> */}
//                     <div className="flex items-center ml-4 space-x-3">
//                       {/* Nút Mời - Luôn hiển thị và active */}
//                       <button
//                         onClick={() =>
//                           inviteFriend(
//                             booking.tableId,
...
//                       {/* Nút Hủy Mời - Hiển thị nhưng mờ khi chưa mời ai */}
//                       <button
//                         onClick={() =>
//                           handleCancelInvitation(
//                             booking.tableId,
